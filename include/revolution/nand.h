...
s32 NANDPrivateGetStatusAsync(const char*, NANDStatus*, NANDCallback, NANDCommandBlock*);

s32 NANDPrivateDeleteAsync(const char*, NANDCallback, NANDCommandBlock*);

s32 NANDPrivateGetTypeAsync(const char*, u8*, NANDCallback, NANDCommandBlock*);

s32 NANDPrivateCreateDirAsync(const char*, u8, u8, NANDCallback, NANDCommandBlock*);
...
#define NANDSetIconSpeed(stat, n, f)                                                                                                                 \
    ((stat)->iconSpeed = (u16)(((stat)->iconSpeed & ~(NAND_BANNER_ICON_ANIM_SPEED_MASK << (2 * (n)))) | ((f) << (2 * (n)))))
