...
BOOL SCGetIdleMode(SCIdleModeInfo* info) { return SCFindByteArrayItem(info, sizeof(*info), SC_ITEM_ID_IPL_IDLE_MODE); }
...
BOOL SCSetWpadMotorMode(u8 mode) { return SCReplaceU8Item(mode, SC_ITEM_ID_BT_MOTOR_MODE); }
...
BOOL SCSetWpadSpeakerVolume(u8 volume) { return SCReplaceU8Item(volume, SC_ITEM_ID_BT_SPEAKER_VOLUME); }
