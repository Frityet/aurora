...
static SCProductAreaAndString ProductAreaAndStringTbl[] = {0, "JPN", 1,  "USA", 2,  "EUR", 3, "AUS", 4, "BRA",
                                                           5, "TWN", 5,  "ROC", 6,  "KOR", 7, "HKG", 8, "ASI",
                                                           9, "LTN", 10, "SAF", 11, "CHN", -1};

static BOOL SCGetProductAreaString(char* buf, u32 bufSize) { return __SCF1("AREA", buf, bufSize); }
...
static SCProductGameRegionAndString ProductGameRegionAndStringTbl[] = {0, "JP", 1, "US", 2, "EU", 4, "KR", 5, "CN", -1};
